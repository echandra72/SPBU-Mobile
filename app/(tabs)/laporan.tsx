...
// Setara "Laporan SPBU" di sidebar web — nama ikon sama persis
...
const MODULES: { label: string; sub: string; route: string; icon: keyof typeof MaterialIcons.glyphMap; color: string; bg: string }[] = [
  { label: 'Laporan Balancing Kas', sub: 'Rekonsiliasi kas & hitung fisik uang', route: '/cash-balancing', icon: 'account-balance-wallet', color: colors.emerald700, bg: colors.emerald50 },
];
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
      <View style={styles.header}>
        <Text style={styles.title}>Laporan SPBU</Text>
